...
public class JpaBoardServiceImpl implements JpaBoardService{
	...
	public void saveBoard(BoardEntity board, MultipartHttpServletRequest multipartHttpServletRequest){
		...
		List<BoardFileEntity> list = fileUtils.parseFileInfoOrNull(multipartHttpServletRequest);
		if(list!=null && CollectionUtils.isEmpty(list) == false){
	...
	@Override
	public BoardFileEntity selectBoardFileInformation(int boardIdx, int idx){
